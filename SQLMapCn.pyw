...
class app(Frame):
    def __init__(self, mw):
        ...
        self.nRoot.add(BuilderFrame, text='SQLMap 命令行构建')
        self.nRoot.add(WatchLog, text='查看日志')
        self.nRoot.add(Editor, text='编辑')
        self.nRoot.add(HelpMe, text='帮助')
        ...
        manual_sqlmap = 'python sqlmap.py -hh'
        ...
        self.reqFile = Text(requestLF, yscrollcommand=reqFile_scr.set,undo=True, height=29, bg='black', fg="#729FCF")
        ...
        logbut.config(text ="日志", command=self.logs)
        logbut.grid(row =1, column=5, sticky='e')
        #full log
        self.chkLog = ttk.Checkbutton(butPanel)
        self.chkLog_var = StringVar()
        self.chkLog.config(text="完整的日志", variable= self.chkLog_var, onvalue= "on" ,
        ...
        self.search_var.set('热键: F3-查找, F4-查找所有')
        ...
        sesFbut.config(text ="打开 session", command=self.fSes)
        ...
        trafbut.config(text ="打开 traffic", command=self.fTraf)
        ...
        #
        urlLF = ttk.Labelframe(panedUrl, text='网址:')
        urlLF.columnconfigure( 0, weight=1)
        urlLF.columnconfigure( 0, weight=1 )
        panedUrl.add(urlLF)
        #
        self.varTarget= StringVar()
        rbURL= ttk.Radiobutton(targetVariant,text='网址',variable=self.varTarget,value="url", command=self.fTarget)
        rbLOG = ttk.Radiobutton(targetVariant,text='日志文件',variable=self.varTarget,value="logFile", command=self.fTarget)
        rbBULKFILE =ttk.Radiobutton(targetVariant,text='列表文件',variable=self.varTarget,value="bulkFile", command=self.fTarget)
        rbREQUEST =ttk.Radiobutton(targetVariant,text='请求文件',variable=self.varTarget,value="requestFile", command=self.fTarget)
        rbDork = ttk.Radiobutton(targetVariant,text='Google目标',variable=self.varTarget,value="googleDork", command=self.fTarget)
        ...
        #query to sqlmap
        queryLF = ttk.Labelframe(panedUrl, text='SqlMap命令语句:')
        ...
        self.noBF.add(sDetTechF, text='注入 | 检测 | 技术')
        self.noBF.add(requestF, text='请求')
        self.noBF.add(enumerationF, text='枚举')
        self.noBF.add(fileF, text='访问')
        ...
        but.config(text ="构造语句",width = 10, command=self.commands)
        #
        but.grid(row=3,column=0, sticky='nw')
        #
        butInj = ttk.Button(BuilderFrame)
        butInj.config(text ="开始",width = 10, command=self.injectIT)
        butInj.grid(row=3,column=0, sticky='ne')
        #General:
        #These options can be used to set some general working parameters
        genOptLF = ttk.Labelframe(setingsF, text='常规')
        ...
        self.chkForms.config(text="表单测试", variable= self.chkForms_var, onvalue= "on" ,
        ...
        self.chkFresh.config(text="忽略结果储存在会话文件", variable= self.chkFresh_var, onvalue= "on" ,
        ...
        self.chkParseEr.config(text="数据库错误信息响应", variable= self.chkParseEr_var, onvalue= "on" ,
        ...
        self.chkFlush.config(text="刷新会话", variable= self.chkFlush_var, onvalue= "on" ,
        ...
        self.chkReplicate.config(text="转储到数据库", variable= self.chkReplicate_var, onvalue= "on" ,
        ...
        self.chkEta.config(text="请求时间显示", variable= self.chkEta_var, onvalue= "on" ,
        ...
        self.chk_Batch.config(text="无交互模式", variable= self.chk_Batch_var, onvalue= "on",
        ...
        self.chk_Hex.config(text="Hex编码", variable= self.chk_Hex_var, onvalue= "on",
        ...
        self.chk_Save.config(text="保存选项到ini", variable= self.chk_Save_var, onvalue= "on",
        ...
        self.chkCharset.config(text="字符编码", variable= self.chkCharset_var, onvalue= "on" ,
        ...
        self.chkCrawl.config(text="爬行深度", variable= self.chkCrawl_var, onvalue= "on" ,
        ...
        self.chkCsv.config(text="排除url", variable= self.chkCsv_var, onvalue= "on" ,
        ...
        self.chkSesFile.config(text="保存会话session文件", variable= self.chkSesFile_var, onvalue= "on" ,
        ...
        self.chkTrafFile.config(text="保存请求文件", variable= self.chkTrafFile_var, onvalue= "on" ,
        ...
        self.chkOutDir.config(text="设置输出目录路径", variable= self.chkOutDir_var, onvalue= "on" ,
        ...
        self.chkDCRED.config(text="数据库身份验证凭据", variable= self.chkDCRED_var, onvalue= "on" ,
        ...
        self.chkTor.config(text = "检查Tor", variable= self.chkTor_var, onvalue= "on" ,
        ...
        self.chkTorUse.config(text = "开Tor代理", variable= self.chkTorUse_var, onvalue= "on" ,
        ...
        self.chkTorPort.config(text="Tor端口", variable= self.chkTorPort_var, onvalue= "on" ,
        ...
        self.chkTorType.config(text="Tor代理类型", variable= self.chkTorType_var, onvalue= "on" ,
        ...
        #Miscellaneous:
        miscOptLF = ttk.Labelframe(setingsF, text='杂项')
        ...
        self.chkBeep.config(text = "发现注入报警", variable= self.chkBeep_var, onvalue= "on" ,
        ...
        self.chkPayload.config(text = "WAF有效测试", variable= self.chkPayload_var, onvalue= "on" ,
        ...
        self.chkWaf.config(text = "检测是否存在WAF", variable= self.chkWaf_var, onvalue= "on" ,
        ...
        self.chkCleanup.config(text = "清除临时表", variable= self.chkCleanup_var, onvalue= "on" ,
        ...
        self.chkDependencies.config(text = "检查缺少非核心的依赖项", variable= self.chkDependencies_var, onvalue= "on" ,
        ...
        self.chkMobile.config(text = "模拟手机协议", variable= self.chkMobile_var, onvalue= "on" ,
        ...
        self.chkRank.config(text = "显示PR", variable= self.chkRank_var, onvalue= "on" ,
        ...
        self.chkPurge.config(text = "删除输出目录", variable= self.chkPurge_var, onvalue= "on" ,
        ...
        self.chkSmart.config(text = "快速检测注入", variable= self.chkSmart_var, onvalue= "on" ,
        ...
        self.chkGpage.config(text="谷歌页码", variable= self.chkGpage_var, onvalue= "on" ,
        ...
        self.chkTSTF.config(text="选择试验载荷", variable= self.chkTSTF_var, onvalue= "on" ,
        ...
        self.chkDHash.config(text = "禁止输出-hash", variable= self.chkDHash_var, onvalue= "on" ,
        ...
        self.chkDLike.config(text = "禁止输出-like", variable= self.chkDLike_var, onvalue= "on" ,
                             offvalue = "off", command= self.fDLike)
        self.chkDLike.grid(row=1,column=5, sticky='w')
        #
        optimiz_LF = ttk.Labelframe(setingsF, text='优化, 请求, 特征 ')
        ...
        self.chkO.config(text="打开所有选项", variable= self.chkO_var, onvalue= "on" ,
        ...
        self.chkPred.config(text="预测输入结果", variable= self.chkPred_var, onvalue= "on" ,
        ...
        self.chkKeep.config(text="持续连接", variable= self.chkKeep_var, onvalue= "on" ,
        ...
        self.chkNull.config(text="只比较响应包长度", variable= self.chkNull_var, onvalue= "on" ,
        ...
        self.chk_thr.config(text="多线程", variable= self.chk_thr_var, onvalue= "on",
        ...
        self.chk_fing.config(text="详细检测数据库类型", variable= self.chk_fing_var, onvalue= "on",
        ...
        self.chk_verb.config(text="输出详细度", variable= self.chk_verb_var, onvalue= "on",
        ...
        #
        injectionLF = ttk.Labelframe(panedITO, text='注入')
        injectionLF.rowconfigure(0, weight=1 )
        injectionLF.columnconfigure( 0, weight=1 )
        #
        tampersLF = ttk.Labelframe(panedITO, text='Tampers脚本 注:WAF绕过设置')
        ...
        self.chkParam.config(text="指定参数", variable= self.chkParam_var, onvalue= "on" ,
        ...
        self.chk_dbms.config(text="数据库类型", variable= self.chk_dbms_var, onvalue= "on" ,
        ...
        self.chkPrefix.config(text="前缀", variable= self.chkPrefix_var, onvalue= "on" ,
        ...
        self.chkSuffix.config(text="后缀", variable= self.chkSuffix_var, onvalue= "on" ,
        ...
        self.chkOS.config(text="操作系统", variable= self.chkOS_var, onvalue= "on" ,
        ...
        self.chkSkip.config(text="跳过参数", variable= self.chkSkip_var, onvalue= "on" ,
        ...
        self.chkLogical.config(text="负载逻辑使用", variable= self.chkLogical_var, onvalue= "on" ,
        ...
        self.chkBigNum.config(text="负载使用", variable= self.chkBigNum_var, onvalue= "on" ,
        ...
        self.chkCast.config(text="关闭制造负载机制", variable= self.chkCast_var, onvalue= "on" ,
        ...
        #
        detectionLF = ttk.Labelframe(panedDTO, text='页面比较')
        detectionLF.columnconfigure( 0, weight=1 )
        #
        techniqueLF = ttk.Labelframe(panedDTO, text='注入方式')
        ...
        self.chkStr.config(text="关键字", variable= self.chkStr_var, onvalue= "on" ,
        ...
        self.chkReg.config(text="正则", variable= self.chkReg_var, onvalue= "on" ,
        ...
        self.chkCode.config(text="代码", variable= self.chkCode_var, onvalue= "on" ,
        ...
        self.chk_level.config(text="等级", variable= self.chk_level_var, onvalue= "on" ,
        ...
        self.chk_risk.config(text="风险度", variable= self.chk_risk_var, onvalue= "on",
        ...
        self.chkTxt.config(text="文本模式", variable= self.chk_Txt_var, onvalue= "on" ,
        ...
        self.chkTit.config(text="标题", variable= self.chk_Tit_var, onvalue= "on" ,
        ...
        self.chk_tech.config(text="注入模式", variable= self.chk_tech_var, onvalue= "on",
        ...
        self.chkCol.config(text="Unoin检测指定数目", variable= self.chkCol_var, onvalue= "on" ,
        ...
        self.chkChar.config(text="Unoin检测指定字符", variable= self.chkChar_var, onvalue= "on" ,
        ...
        self.chkSec.config(text="查询延迟时间", variable= self.chkSec_var, onvalue= "on" ,
        ...
        self.chkDNS.config(text="指定DNS渗出", variable= self.chkDNS_var, onvalue= "on" ,
        ...
        self.chkRandomAg.config(text = "随机User-Agent", variable= self.chkRandomAg_var, 
		onvalue= "on", offvalue = "off", command= self.fRandomAg)
        self.chkRandomAg.grid(row=0,column=0, sticky='w')
		
        #--data=DATA         Data string to be sent through POST
        self.chkdata = ttk.Checkbutton(dataLF)
        self.chkdata_var = StringVar()
        self.chkdata.config(text = "Post数据", variable= self.chkdata_var, onvalue= "on" ,
        ...
        self.chkPDEL.config(text = "用于拆分参数值的字符", variable= self.chkPDEL_var, onvalue= "on" ,
        ...
        self.chkCook.config(text="cookie值数据", variable= self.chkCook_var, onvalue= "on" ,
        ...
        self.chkLoadCookies.config(text="载入cookies", variable= self.chkLoadCookies_var, onvalue= "on" ,
        ...
        self.chkCookieUrlencode.config(text="cookie-url编码", variable= self.chkCookieUrlencode_var, onvalue= "on" ,
        ...
        self.chkDropSetCookie.config(text="忽略Set-Cookie头响应", variable= self.chkDropSetCookie_var, onvalue= "on" ,
        ...
        self.chkUA.config(text="HTTP用户代理标头", variable= self.chkUA_var, onvalue= "on" ,
        ...
        self.chkRandomize.config(text="随机更改给定参数的值", variable= self.chkRandomize_var, onvalue= "on" ,
        ...
        self.chkForceSsl.config(text="使用SSL/HTTPS请求", variable= self.chkForceSsl_var, onvalue= "on" ,
        ...
        self.chkHOST.config(text="HTTP Host 头", variable= self.chkHOST_var, onvalue= "on" ,
        ...
        self.chkReferer.config(text="使用referer欺骗", variable= self.chkReferer_var, onvalue= "on" ,
        ...
        self.chkHeaders.config(text="额外的请求头", variable= self.chkHeaders_var, onvalue= "on" ,
        ...
        self.chkPROXY.config(text = "HTTP代理", variable= self.chkPROXY_var, onvalue= "on" ,
        ...
        self.chkPCRED.config(text = "HTTP代理身份验证凭据", variable= self.chkPCRED_var, onvalue= "on" ,
        ...
        self.chkPignore.config(text = "忽略系统默认的HTTP代理", variable= self.chkPignore_var, onvalue= "on" ,
        ...
        self.chkATYPE.config(text = "HTTP身份验证类型", variable= self.chkATYPE_var, onvalue= "on" ,
        ...
        self.chkACRED.config(text = "HTTP身份验证凭证(名称:密码）", variable= self.chkACRED_var, onvalue= "on" ,
        ...
        self.chkACERT.config(text = "HTTP身份验证的证书", variable= self.chkACERT_var, onvalue= "on" ,
        ...
        self.chkDELAY.config(text = "每个HTTP请求之间的延迟时间(秒)", variable= self.chkDELAY_var, onvalue= "on" ,
        ...
        self.chkTIMEOUT.config(text = "从连接的默认超时前等待(每秒30)", variable= self.chkTIMEOUT_var, onvalue= "on" ,
        ...
        self.chkRETRIES.config(text = "连接超时,重新连接(默认3)", variable= self.chkRETRIES_var, onvalue= "on" ,
        ...
        self.chkSCOPE.config(text = "正则表达式来筛选目标提供代理日志", variable= self.chkSCOPE_var, onvalue= "on" ,
        ...
        self.chkSAFURL.config(text = "在测试过程中经常访问的URL地址", variable= self.chkSAFURL_var, onvalue= "on" ,
        ...
        self.chkSAFREQ.config(text = "在两次访问之间提供安全URL的请求", variable= self.chkSAFREQ_var, onvalue= "on" ,
        ...
        self.chkSkipUrlencode.config(text = "跳过的URL编码的有效载荷数据", variable= self.chkSkipUrlencode_var, onvalue= "on" ,
        ...
        self.chkEVALCODE.config(text = "评估前提供Python代码请求", variable= self.chkEVALCODE_var, onvalue= "on" ,
        ...
        self.chkdata = ttk.Checkbutton(dataLF2)
        self.chkdata_var = StringVar()
        self.chkdata.config(text = "指定HTTP方法", variable= self.chkdata_var, onvalue= "on" ,
                            offvalue = "off", command= self.chekdata)
        self.chkdata.grid(row=14,column=0, sticky='w')
		#
        self.entryData = ttk.Entry(dataLF2, width=60)
        self.entryData.grid(row =14,column=1, sticky='we',padx=3)
        self.entryData.columnconfigure(0, weight=1)
		#--safe-post=SAFE..  POST data to send to a safe URL 
        self.chkSAFURL = ttk.Checkbutton(dataLF2)
        self.chkSAFURL_var = StringVar()
        self.chkSAFURL.config(text = "Post数据到安全的URL地址", variable= self.chkSAFURL_var, onvalue= "on" ,
                              offvalue = "off", command= self.fSAFURL)
        self.chkSAFURL.grid(row=15,column=0, sticky='w')
        #
        self.eSAFURL = ttk.Entry(dataLF2, width=60)
        self.eSAFURL.grid(row =15,column=1, sticky='we',padx=3)
        self.eSAFURL.columnconfigure(0, weight=1)
        #
        ...
        self.chkCurrent_user.config(text="当前用户", variable= self.chkCurrent_user_var, onvalue= "on" ,
        ...
        self.chkCurrent_db.config(text="当前数据库", variable= self.chkCurrent_db_var, onvalue= "on" ,
        ...
        self.chk_is_dba.config(text="是否是DBA", variable= self.chk_is_dba_var, onvalue= "on" ,
        ...
        self.chk_users.config(text="用户", variable= self.chk_users_var, onvalue= "on" ,
        ...
        self.chk_passwords.config(text="密码", variable= self.chk_passwords_var, onvalue= "on" ,
        ...
        self.chk_privileges.config(text="权限", variable= self.chk_privileges_var, onvalue= "on" ,
        ...
        self.chk_roles .config(text="角色", variable= self.chk_roles_var, onvalue= "on" ,
        ...
        self.chk_dbs.config(text="数据库", variable= self.chk_dbs_var, onvalue= "on" ,
        ...
        self.chk_tables.config(text="表", variable= self.chk_tables_var, onvalue= "on" ,
        ...
        self.chk_columns.config(text="字段", variable= self.chk_columns_var, onvalue= "on" ,
        ...
        self.chk_schema.config(text="架构", variable= self.chk_schema_var, onvalue= "on" ,
        ...
        self.chk_count.config(text="计数", variable= self.chk_count_var, onvalue= "on" ,
        ...
        self.chk_Banner.config(text="数据库版本", variable= self.chk_Banner_var, onvalue= "on",
        ...
        self.chk_dump.config(text="数据读取", variable= self.chk_dump_var, onvalue= "on" ,
        ...
        self.chk_dump_all.config(text="读取全部数据", variable= self.chk_dump_all_var, onvalue= "on" ,
        ...
        self.chk_search.config(text="搜索", variable= self.chk_search_var, onvalue= "on" ,
        ...
        self.chk_exclude.config(text="排除系统数据库", variable= self.chk_exclude_var, onvalue= "on" ,
        ...
        self.chk_first.config(text="首字符", variable= self.chk_first_var, onvalue= "on" ,
        ...
        self.chk_last.config(text="尾字符", variable= self.chk_last_var, onvalue= "on" ,
        ...
        self.chkD.config(text="数据库", variable= self.chkD_var, onvalue= "on" ,
        ...
        self.chkT.config(text="表名", variable= self.chkT_var, onvalue= "on" ,
        ...
        self.chkC.config(text="字段", variable= self.chkC_var, onvalue= "on" ,
        ...
        self.chkUSER.config(text="用户", variable= self.chkUSER_var, onvalue= "on" ,
        ...
        self.chk_start.config(text="限定范围", variable= self.chk_start_var, onvalue= "on" ,
        ...
        self.chkQuery.config(text="执行SQL语句", variable= self.chkQuery_var, onvalue= "on" ,
        ...
        self.chkSqlShell.config(text="交互式SQL命令", variable= self.chkSqlShell_var, onvalue= "on" ,
                              offvalue = "off", command= self.fSqlShell)
        self.chkSqlShell.grid(row=1,column=0,sticky = 'w')

        #Brute force
        charbfLF = ttk.Labelframe(enumerationF, text='暴力')
        ...
        self.chkBFt.config(text="表名", variable= self.chkBFt_var, onvalue= "on" ,
        ...
        self.chkBFc.config(text="字段", variable= self.chkBFc_var, onvalue= "on" ,
        ...
        AccessF.add(fileAcc, text='读取文件')
        AccessF.add(OsAcc, text='命令执行')
        AccessF.add(WinRegAcc, text='读取注册表')
        ...
        self.chkFile.config(text="读取文件 ", variable= self.chkFile_var, onvalue= "on" ,
        ...
        self.chkWFILE.config(text="导入文件", variable= self.varWFILE, onvalue= "on" ,
        ...
        self.chkDFILE.config(text="写入文件", variable= self.chkDFILE_var, onvalue= "on" ,
        ...
        self.viewfile.config(text ="查看日志", command=self.vfile)
        ...
        #
        catLF = ttk.Labelframe(configDL, text='类别')
        catLF.rowconfigure( 0, weight=1 )
        catLF.columnconfigure( 0, weight=1 )
        #
        listLF = ttk.Labelframe(configDL, text='默认 *日志, *配置')
        ...
        self.chkOSCMD.config(text="执行命令", variable= self.chkOSCMD_var, onvalue= "on" ,
        ...
        self.chkShell.config(text="交互式shell", variable= self.chkShell_var, onvalue= "on" ,
        ...
        self.chkPWN.config(text="反弹一个shell", variable= self.chkPWN_var, onvalue= "on" ,
        ...
        self.chkSmbrelay.config(text="SMB会话劫持", variable= self.chkSmbrelay_var, onvalue= "on" ,
        ...
        self.chkBOF.config(text="数据缓冲区溢出", variable= self.chkBOF_var, onvalue= "on" ,
        ...
        self.chkPrivEsc.config(text="数据库权限提升", variable= self.chkPrivEsc_var, onvalue= "on" ,
        ...
        self.chkMSFPATH.config(text="Metasploit路径", variable= self.chkMSFPATH_var, onvalue= "on" ,
        ...
        self.chkTMPPATH.config(text="远程临时文件目录路径", variable= self.chkTMPPATH_var, onvalue= "on" ,
        ...
        self.chkRegRead.config(text="读取注册表", variable= self.chkRegRead_var, onvalue= "on" ,
        ...
        self.chkRegAdd.config(text="添加注册表", variable= self.chkRegAdd_var, onvalue= "on" ,
        ...
        self.chkRegDel.config(text="删除注册表", variable= self.chkRegDel_var, onvalue= "on" ,
        ...
        self.chkREGKEY.config(text="注册表键", variable= self.chkREGKEY_var, onvalue= "on" ,
        ...
        self.chkREGVAL.config(text="注册表键值", variable= self.chkREGVAL_var, onvalue= "on" ,
        ...
        self.chkREGDATA.config(text="注册表键值数据", variable= self.chkREGDATA_var, onvalue= "on" ,
        ...
        self.chkREGTYPE.config(text="注册表键值类型", variable= self.chkREGTYPE_var, onvalue= "on" ,
    ...
    def injectIT(self,*args):
        if (os.name == "posix"):
            ...
            cmd = "sakura -h -e python sqlmap.py %s" % (self.sqlEdit.get())
        else:
    ...
    def rClicker(self, e):
        try:
            ...
            e.widget.focus()
            nclst=[
                ('剪切', lambda e=e: rClick_Cut(e)),
                ('复制', lambda e=e: rClick_Copy(e)),
                ('粘贴', lambda e=e: rClick_Paste(e)),
            ]
